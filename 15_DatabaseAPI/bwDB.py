...
class bwDB:
    def __init__(self, **kwargs):
        # line string as the first line of any function, method, or class
        # serves as documentation for that function, method, or class
        """
    ...
    def insert_nocommit(self, rec):
        """
            ...
            rec is a dict with key/value pairs corresponding to tableschema
    ...
    def update_nocommit(self, recid, rec):
        """
            ...
            update a row in the table
                ...
                rec is a dict with key/value pairs corresponding to table
                schema
        """
        klist = sorted(rec.keys())
        values = [rec[v] for v in klist]  # a list of values ordered by key
...
def test():
    ...
    db.sql_do(f' CREATE TABLE {t}(id INTEGER PRIMARY KEY,'
