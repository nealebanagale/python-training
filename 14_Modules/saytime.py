...
class saytime(numwords):    # inherits from numwords class
    '''
    ...
    def words(self):
        ...
        if m == 0:
            if h in (0, 12):
                ...
                return "{} {}".format(self.numwords(h),
                                      self._words['quarters'][m])
        if m % 15 == 0:
            return "{} {} {}".format(self._words['quarters'][m // 15],
                                     sign, hword)
